    ...
    <section id="toolkit" className="py-20 bg-cyber-dark">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Coming Soon */}
          <div className="bg-gradient-to-br from-cyber-gold/10 to-cyber-gold/5 p-6 rounded-xl border border-cyber-gold/50 shadow-none">
            <div className="text-center mb-4">
              <Rocket className="w-12 h-12 text-cyber-gold mb-3 mx-auto" />
              <h3 className="font-orbitron text-lg font-bold text-cyber-gold">CryptoOpsec Tools</h3>
            </div>
